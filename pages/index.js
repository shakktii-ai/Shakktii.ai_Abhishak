...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.अभिषेक बाळासाहेब कळमकर.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        225- अ.नगर विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          ...
          <span className="font-bold">श्री.अभिषेक बाळासाहेब कळमकर</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
